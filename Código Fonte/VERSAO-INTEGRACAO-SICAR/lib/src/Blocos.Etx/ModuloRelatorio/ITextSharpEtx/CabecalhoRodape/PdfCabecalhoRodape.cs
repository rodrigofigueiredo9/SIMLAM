...
{
	public class PdfCabecalhoRodape : PdfPageEventHelper, ICabecalhoRodape, IPageMirroring
	{
		#region Atributos
		...
		public bool IsPageMirroring { get; set; }
		...
		public override void OnOpenDocument(PdfWriter writer, Document document)
		{
			...
			tabelaLinha.SetWidths(new float[] { 15, 85 });
		...
		public override void OnEndPage(PdfWriter writer, Document document)
		{
			...
			tabelaRodape.WriteSelectedRows(0, -1, document.Left, document.PageSize.Height - (document.PageSize.Height - 47), cb);
