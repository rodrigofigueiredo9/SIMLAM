<%@ Import Namespace="Tecnomapas.EtramiteX.Gerencial.ViewModels.VMFuncionario" %>
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Gerencial.Master" Inherits="System.Web.Mvc.ViewPage<EditarVM>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Alterar Dados de Funcionário</asp:Content>
