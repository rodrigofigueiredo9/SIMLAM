...
namespace Tecnomapas.EtramiteX.WindowsService.ProcessOperacoesGeo.Business.PDF
{
	...
	public class PdfMetodosAuxiliares
	{
        ...
        */
		...
		private static void ExportarFontes(string path)
		{
			...
			using (Stream stream = tipoClasse.Assembly.GetManifestResourceStream(nameSpace + ".PDF.Fontes.ARIALN.TTF"))
			{
			...
			using (Stream stream = tipoClasse.Assembly.GetManifestResourceStream(nameSpace + ".PDF.Fontes.ariblk.ttf"))
			{
			...
			using (Stream stream = tipoClasse.Assembly.GetManifestResourceStream(nameSpace + ".PDF.Fontes.ARIAL.TTF"))
			{
			...
			using (Stream stream = tipoClasse.Assembly.GetManifestResourceStream(nameSpace + ".PDF.Fontes.ArialBold.ttf"))
			{
			...
			using (Stream stream = tipoClasse.Assembly.GetManifestResourceStream(nameSpace + ".PDF.Fontes.arialbi.ttf"))
			{
			...
			using (Stream stream = tipoClasse.Assembly.GetManifestResourceStream(nameSpace + ".PDF.Fontes.ariali.ttf"))
			{
