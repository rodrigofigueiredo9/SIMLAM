...
{
	public class PdfCabecalhoRodape : PdfPageEventHelper, IPageMirroring
	{
		#region Atributos
		...
		private static Stream ImagemOrgao { get { return Assembly.GetExecutingAssembly().GetManifestResourceStream("Tecnomapas.EtramiteX.WindowsService.ProcessOperacoesGeo.Business.PDF.Imagens.logomarca.png"); } }

		private static Stream ImagemSimlam { get { return Assembly.GetExecutingAssembly().GetManifestResourceStream("Tecnomapas.EtramiteX.WindowsService.ProcessOperacoesGeo.Business.PDF.Imagens.logomarca_simlam.png"); } }
		...
		public override void OnEndPage(PdfWriter writer, Document document)
		{
			...
			tabelaCabecalho.WriteSelectedRows(0, -1, document.LeftMargin, document.PageSize.Height - 30, cb);


			// Rodapé
			tabelaRodape.TotalWidth = (document.Right - document.Left);
			tabelaRodape.WriteSelectedRows(0, -1, document.LeftMargin, 47, cb);
