...
<div class="modalVisualizarEmpreendimento">
	...
	<fieldset class="block box">
		...
		<div class="block">
			<div class="coluna30">
				...
				<%= Html.TextBox("Filtros.Codigo", Model.Empreendimento.Codigo, new { @class = "text disabled txtCodigo setarFoco maskIntegerObrigatorio", @disabled = "disabled" })%>
			</div>
		</div>
		<div class="block">
			<div class="coluna40">
	...
	<fieldset class="block box">
		...
		<div class="block">
			<label>Utilizar o mesmo endereço de localização de empreedimento?</label>
			<label><%= Html.RadioButton("Empreendimento.TemCorrespondencia", IsCorrespondencia.SIM, Model.Empreendimento.TemCorrespondencia == IsCorrespondencia.NAO, new { @class = "radio disabled", @disabled = "disabled" })%> Sim</label>
			<label class="append5"><%= Html.RadioButton("Empreendimento.TemCorrespondencia", IsCorrespondencia.NAO, Model.Empreendimento.TemCorrespondencia != IsCorrespondencia.NAO, new { @class = "radio disabled", @disabled = "disabled" })%> Não</label>
		</div>
