...
Processo = {
	...
	configurarAssociarMultiplo: function () {
		...
		$('.divConteudoResponsavelTec', Processo.settings.container).associarMultiplo({
			'onAssociar': null, //Processo.associarResponsavelTecnico,
			'associarUrl': Processo.settings.urls.associarResponsavelModal,
			'associarModalObject': null,//Processo.pessoaModalResp,
			'associarModalLoadFunction': null,//Processo.pessoaModalResp.load,
			...
			'editarModalObject': null, //Processo.pessoaModalResp,
			'editarModalLoadFunction': null, //Processo.pessoaModalResp.load,
			...
			'minItens': 1,
			'tamanhoModal': Modal.tamanhoModalGrande,
			'onExpandirEsconder': null,//function () { MasterPage.redimensionar(); },
