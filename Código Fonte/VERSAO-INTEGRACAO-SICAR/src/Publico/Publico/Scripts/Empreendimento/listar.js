...
EmpreendimentoListar = {
	...
	load: function (container, options) {
		...
		EmpreendimentoListar.container = MasterPage.getContent(container);
	...
	associar: function () {
		...
		retorno = EmpreendimentoListar.settings.associarFuncao({ Id: itemId, Denominador: itemDenominador, CNPJ: itemCnpj });
