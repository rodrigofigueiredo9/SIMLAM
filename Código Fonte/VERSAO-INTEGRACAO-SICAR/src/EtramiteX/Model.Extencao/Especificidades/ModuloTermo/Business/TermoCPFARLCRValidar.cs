...
{
	public class TermoCPFARLCRValidar : EspecificidadeValidarBase, IEspecificiadeValidar
	{
		...
		public bool AdicionarARL(int empReceptor, int empReservaLegal)
		{
			if (empReceptor != empReservaLegal)
			{
				Validacao.Add(Mensagem.TermoCPFARLCR.ARLEmpreendmentoReceptorDiferente);
			}
