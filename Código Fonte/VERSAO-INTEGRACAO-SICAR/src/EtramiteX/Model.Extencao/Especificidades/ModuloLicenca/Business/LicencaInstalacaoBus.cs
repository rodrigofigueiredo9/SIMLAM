...
{
	public class LicencaInstalacaoBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		LicencaInstalacaoDa _da = new LicencaInstalacaoDa();
		...
		{
			get { return new LicencaInstalacaoValidar(); }
		}
		...
		{
			LicencaInstalacao Licenca = especificidade as LicencaInstalacao;
		...
		{
			return Deserialize(input, typeof(LicencaInstalacao));
		}
