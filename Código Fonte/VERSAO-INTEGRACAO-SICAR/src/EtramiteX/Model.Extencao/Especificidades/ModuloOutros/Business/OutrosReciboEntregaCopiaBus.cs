...
{
	public class OutrosReciboEntregaCopiaBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		OutrosReciboEntregaCopiaDa _da = new OutrosReciboEntregaCopiaDa();
		...
		{
			get { return new OutrosReciboEntregaCopiaValidar(); }
		}
		...
		{
			OutrosReciboEntregaCopia outros = especificidade as OutrosReciboEntregaCopia;
		...
		{
			return Deserialize(input, typeof(OutrosReciboEntregaCopia));
		}
