...
{
	public class LaudoVistoriaFomentoFlorestalVM
	{
		...
		public String IdsTela
		{
			get
			{
				...
				{
					@EspecificidadeConclusaoFavoravel = eEspecificidadeConclusao.Favoravel,
					@EspecificidadeConclusaoDesfavoravel = eEspecificidadeConclusao.Desfavoravel
				});
			}
		}

		private LaudoVistoriaFomentoFlorestal _laudo = new LaudoVistoriaFomentoFlorestal();
		public LaudoVistoriaFomentoFlorestal Laudo
		{
			get { return _laudo; }
			set
			{
		...
		public LaudoVistoriaFomentoFlorestalVM() 
		{
