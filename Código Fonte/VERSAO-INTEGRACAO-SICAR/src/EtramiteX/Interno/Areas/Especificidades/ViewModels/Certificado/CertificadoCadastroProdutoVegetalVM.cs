...
{
	public class CertificadoCadastroProdutoVegetalVM
	{
		...
		private CertificadoCadastroProdutoVegetal _certificado = new CertificadoCadastroProdutoVegetal();
		public CertificadoCadastroProdutoVegetal Certificado
		{
