...
{
	public class LicencaOperacaoVM
	{
		...
		private LicencaOperacao _licenca = new LicencaOperacao();
		public LicencaOperacao Licenca
		{
			get { return _licenca; }
			set { _licenca = value; }
		}
		...
		public LicencaOperacaoVM(List<Protocolos> processosDocumentos, List<AtividadeSolicitada> atividades, List<PessoaLst> destinatarios, LicencaOperacao licenca, List<TituloCondicionante> condicionantes, string processoDocumentoSelecionado, bool isVisualizar, int atividadeSelecionada)
		{
