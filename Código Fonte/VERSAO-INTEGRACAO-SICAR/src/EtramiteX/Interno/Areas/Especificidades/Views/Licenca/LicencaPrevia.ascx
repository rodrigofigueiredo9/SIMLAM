...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<LicencaPreviaVM>" %>
<%@ Import Namespace="Tecnomapas.EtramiteX.Interno.ViewModels" %>

<script type="text/javascript" src="<%= Url.Content("~/Scripts/Areas/Especificidades/Licenca/LicencaPrevia.js") %>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Scripts/Titulo/listar.js") %>"></script>
<script type="text/javascript">
	LicencaPrevia.settings.urls.obterDadosLicencaPrevia = '<%= Url.Action("ObterDadosLicencaPorteUsoMotosserra", "Licenca", new {area="Especificidades"}) %>';
