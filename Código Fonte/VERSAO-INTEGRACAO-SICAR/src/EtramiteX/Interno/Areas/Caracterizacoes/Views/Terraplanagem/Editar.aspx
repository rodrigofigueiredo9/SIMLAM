...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Editar Terraplanagem</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="JsHeadContent" runat="server">
	<script type="text/javascript" src="<%= Url.Content("~/Scripts/Areas/Caracterizacoes/Terraplanagem.js") %>"></script>
	...
	<script type="text/javascript">
		$(function () {
			Terraplanagem.load($('#central'), {
				urls: {
					salvar: '<%= Url.Action("Editar", "Terraplanagem") %>',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		<h1 class="titTela">Editar Terraplanagem</h1>
		<br />
