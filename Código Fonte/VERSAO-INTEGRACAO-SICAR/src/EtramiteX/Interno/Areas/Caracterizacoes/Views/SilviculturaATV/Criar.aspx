...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Salvar Silvicultura - Implantação da Atividade de Silvicultura (Fomento)</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="JsHeadContent" runat="server">
	<script type="text/javascript" src="<%= Url.Content("~/Scripts/Areas/Caracterizacoes/silviculturaAtv.js") %>"></script>	
	<script type="text/javascript">
		$(function () {
			SilviculturaATV.load($('#central'), {
				urls: {
					salvar: '<%= Url.Action("Criar", "SilviculturaATV") %>',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		<h1 class="titTela">Salvar Silvicultura - Implantação da Atividade de Silvicultura (Fomento)</h1>
		<br />
