...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Salvar Suinocultura</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="JsHeadContent" runat="server">
	<script type="text/javascript" src="<%= Url.Content("~/Scripts/Areas/Caracterizacoes/suinocultura.js") %>"></script>
	...
	<script type="text/javascript">
		$(function () {
			Suinocultura.load($('#central'), {
				urls: {
					salvar: '<%= Url.Action("Criar", "Suinocultura") %>',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		<h1 class="titTela">Salvar Suinocultura</h1>
		<br />
