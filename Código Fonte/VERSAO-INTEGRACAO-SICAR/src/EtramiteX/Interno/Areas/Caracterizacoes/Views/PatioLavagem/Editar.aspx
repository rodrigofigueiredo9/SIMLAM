...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Editar Pátio de Lavagem, Abastecimento e Descontaminação de Aeronave Agrícola</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="JsHeadContent" runat="server">
	<script type="text/javascript" src="<%= Url.Content("~/Scripts/Areas/Caracterizacoes/patioLavagem.js") %>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		<h1 class="titTela">Editar Pátio de Lavagem, Abastecimento e Descontaminação de Aeronave Agrícola</h1>
		<br />
