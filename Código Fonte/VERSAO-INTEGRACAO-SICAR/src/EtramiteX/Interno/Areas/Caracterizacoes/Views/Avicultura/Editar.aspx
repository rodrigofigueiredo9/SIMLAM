...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Editar Avicultura</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="JsHeadContent" runat="server">
	<script type="text/javascript" src="<%= Url.Content("~/Scripts/Areas/Caracterizacoes/avicultura.js") %>"></script>
	...
	<script type="text/javascript">
		$(function () {
			Avicultura.load($('#central'), {
				urls: {
					salvar: '<%= Url.Action("Editar", "Avicultura") %>',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		<h1 class="titTela">Editar Avicultura</h1>
		<br />
