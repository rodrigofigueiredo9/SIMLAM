...
<script language="JavaScript" type="text/javascript">
	...
	var conf = { webserviceURL: '<%= Model.DesenhadorWebserviceURL %>' };
	...
	function obterConfiguracoes() {
	    desenhador.setConfiguracao(conf.webserviceURL);
	}
	...
	function onBaixarArquivo(id, tipo) {
		Navegador.settings.onBaixarArquivo(id, tipo);
	}
