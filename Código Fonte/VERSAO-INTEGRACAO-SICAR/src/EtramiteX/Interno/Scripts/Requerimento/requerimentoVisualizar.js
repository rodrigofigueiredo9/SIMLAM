...
RequerimentoResponsavel = {
	...
	configurarAssociarMultiploResponsavel: function () {
		...
		$('.divConteudoResponsavelTec').associarMultiplo({
			'associarModalObject': RequerimentoResponsavel.modalPessoaResp,
			'associarModalLoadFunction': RequerimentoResponsavel.modalPessoaResp.load,
			'associarModalLoadParams': {
				tituloVerificar: 'Cadastrar Responsável',
