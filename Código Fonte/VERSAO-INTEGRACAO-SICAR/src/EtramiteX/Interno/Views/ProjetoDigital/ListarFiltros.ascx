...
<h1 class="titTela">Requerimentos Digitais</h1>
<br />
	...
	<div class="filtroCorpo filtroSerializarAjax block">
		...
		<div class="coluna98">
			...
			<div class="block hide">
				<div class="coluna26">
					<label for="Filtros_InteressadoCpfCnpj"><%= Html.RadioButton("Filtros.IsCpf", true, true, new { @class = "radio radioInteressadoCpfCnpj radioCPF" })%>CPF</label>
					<label for="Filtros_InteressadoCpfCnpj"><%= Html.RadioButton("Filtros.IsCpf", false, false, new { @class = "radio radioInteressadoCpfCnpj" })%>CNPJ do interessado</label>
