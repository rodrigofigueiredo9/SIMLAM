...
<table class="dataGridTable tabTramitacoesRecebidas" width="100%" border="0" cellspacing="0" cellpadding="0">
	<thead>
		<tr>
			<th><input type="checkbox" class="ckbCheckAllInMyColumn" />Processo/Documento</th>
			<th width="17%">Enviado em</th>
	...
	<tbody>
		<% for (int i = 0; i < Model.Tramitacoes.Itens.Count; i++)
	  {
		...
		<tr class="trTramitacao">
			<td>
				<input type="checkbox" class="ckbSelecionavel" <%= tramitacao.IsSelecionado ? "checked=\"checked\"" : "" %> />
