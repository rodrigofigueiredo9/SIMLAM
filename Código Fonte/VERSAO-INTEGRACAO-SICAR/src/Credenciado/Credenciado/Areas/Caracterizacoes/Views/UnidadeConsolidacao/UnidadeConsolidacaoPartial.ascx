	...
	<fieldset class="block boxBranca">
		<div class="block">
			<div class="coluna22">
				...
				<label><%= Html.RadioButton("PossuiCodigoUC", true, Model.UnidadeConsolidacao.PossuiCodigoUC, ViewModelHelper.SetaDisabled((Model.FoiCopiada || Model.IsVisualizar || Model.UnidadeConsolidacao.Id > 0), new { @class = "radio RadioCodigoUC rbPossuiCodigoSim" }))%>Sim</label>
				<label><%= Html.RadioButton("PossuiCodigoUC", false, !Model.UnidadeConsolidacao.PossuiCodigoUC, ViewModelHelper.SetaDisabled((Model.FoiCopiada || Model.IsVisualizar || Model.UnidadeConsolidacao.Id > 0), new { @class = "radio RadioCodigoUC rbPossuiCodigoNao" }))%>Não</label>
			</div>

			<div class="coluna30 prepend1">
				<label for="CodigoPropriedade">Código da UC *</label>
				<%= Html.TextBox("CodigoPropriedade", ((Model.UnidadeConsolidacao.CodigoUC > 0) ? Model.UnidadeConsolidacao.CodigoUC.ToString() : "Gerado automaticamente"), ViewModelHelper.SetaDisabled(Model.FoiCopiada || Model.IsVisualizar || !Model.UnidadeConsolidacao.PossuiCodigoUC, new { @class = "text txtCodigoUC maskNumInt", @maxlength = "11" }))%>
			</div>
		</div>
