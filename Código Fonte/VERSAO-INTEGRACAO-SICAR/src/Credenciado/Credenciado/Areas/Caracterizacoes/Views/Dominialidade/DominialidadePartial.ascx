...
<input type="hidden" class="hdnEmpreendimentoInternoId" value="<%:Model.Caracterizacao.EmpreendimentoInternoId%>" />
...
<fieldset class="block box filtroExpansivoAberto">
	...
	<div class="block filtroCorpo">
		...
		<%= Html.Hidden("Dominialidade.InternoID", Model.Caracterizacao.InternoID, new { @class = "hdnInternoId"})%>
	</div>
</fieldset>