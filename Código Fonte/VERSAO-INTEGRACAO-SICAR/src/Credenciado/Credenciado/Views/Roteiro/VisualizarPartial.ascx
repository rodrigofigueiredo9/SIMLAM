<%@ Import Namespace="Tecnomapas.EtramiteX.Credenciado.ViewModels.VMRoteiro" %>
...
<fieldset class="block box">
	...
	<div class="block divFinalidade <%= Model.Roteiro.Atividades.Count >  0 ? "" : "hide" %>">
		...
		<div class="block finalidades">
			...
			<div class="finalidade coluna<%= i == 0 ? 10 : 15 %> append2">
...
<div class="block box">
	<div class="block">
		<div class="coluna100">
			...
			<%= Html.TextArea("Roteiro.Observacoes", Model.Roteiro.Observacoes, new { disabled = "disabled", @class = "media disabled" })%>
		</div>
	</div>
	<div class="block">
		<div class="dataGrid">
