...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Credenciado.Master" Inherits="System.Web.Mvc.ViewPage<ListarAtividadesSolicitadasVM>" %>
...
<script type="text/javascript">
	$(function () {
		...
		AtividadesSolicitadas.urlVisualizarPdf = '<%= Url.Action("GerarPdfInterno", "Requerimento") %>';
