...
<div class="pessoaPartial">
	...
	<input type="hidden" name="InternoId" value="<%= Model.Pessoa.InternoId %>" />
	<input type="hidden" class="pessoaCpfCnpj" name="CPFCNPJ" value="<%= Model.Pessoa.CPFCNPJ %>" />
	...
	<%= Html.Hidden("Pessoa.IsCopiado", Model.Pessoa.IsCopiado, new { @class = "hdnIsCopiado" })%>
	<%= Html.Hidden("IsConjuge", Model.IsConjuge.ToString().ToLower(), new { @class = "hdnIsConjuge" })%>
