...
<div class="pessoaPartial">
	...
	<%= Html.Hidden("Pessoa.IsCopiado", Model.Pessoa.IsCopiado.ToString().ToLower(), new { @class = "hdnIsCopiado" })%>
	<%= Html.Hidden("IsConjuge", Model.IsConjuge, new { @class = "hdnIsConjuge" })%>
