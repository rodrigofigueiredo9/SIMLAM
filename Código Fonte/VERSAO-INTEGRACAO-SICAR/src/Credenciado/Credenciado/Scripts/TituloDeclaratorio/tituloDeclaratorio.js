...
TituloDeclaratorio = {
	...
	associarRequerimento: function () {
		Modal.abrir(TituloDeclaratorio.settings.urls.associarRequerimento, null, function (container) {
			ProjetoDigitalListar.load(container, { associarFuncao: TituloDeclaratorio.callBackAssociarRequerimento, urlVisualizarRequerimento: TituloDeclaratorio.settings.urls.visualizarRequerimento });
			Modal.defaultButtons(container);
		});
	},

	callBackAssociarRequerimento: function (objeto) {
		objeto = JSON.parse(objeto);
		var requerimento = {
			Id: objeto.RequerimentoId,
			EmpreendimentoId: objeto.EmpreendimentoId,
			EmpreendimentoDenominador: objeto.EmpreendimentoDenominador
		};
