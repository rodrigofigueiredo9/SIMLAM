...
namespace Tecnomapas.EtramiteX.Credenciado.Model.RelatorioIndividual.ModuloRoteiro.Data
{
	public class RoteiroRelatorioInternoDa
	{
		private string EsquemaBanco { get; set; }

		public RoteiroRelatorioInternoDa(string strBancoDeDados = null)
		{
