...
namespace Tecnomapas.EtramiteX.Gerencial.Model.Security
{
	public class GerenciarAutenticacao
	{
		private static FuncionarioGerencialBus _busFunc = new FuncionarioGerencialBus(new FuncionarioValidar());
