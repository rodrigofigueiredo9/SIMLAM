...
<div class="fundoModal hide modalTemplate" >
	<div class="modalBranco">
		<div class="block">
			<a class="fecharModal fMdl" title="Fechar">Fechar</a>
		</div>
		<div class="boxModal">
		...
		<div class="modelBotoes block hide">
			<input type="button" value="Ok" class="btnModalOk floatLeft" />
			<span class="btnModalCancelar cancelarCaixa"><span class="btnModalOu">ou</span> <a class="linkCancelar">Cancelar</a></span>
		</div>
	</div>
</div>
<!-- ========================================================================= -->
