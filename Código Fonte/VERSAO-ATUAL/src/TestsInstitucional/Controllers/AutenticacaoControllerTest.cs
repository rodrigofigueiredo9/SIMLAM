...
namespace Tests
{
	...
	public class AutenticacaoControllerTest
	{
        ...
        public void DeveRetornarHomeIndexAoLogarComSucesso()
        {
			...
			this.assertNormalLoginBehavior("karine.goncalves", "123456");
        }
		...
		public void DeveRetornarPartialViewAoTentarLogar()
		{
			...
			var result = testController.LogOn("karine.goncalves", "1234567", null, null, null, null) as PartialViewResult;
		...
		public void DeveRedirecionarAoLogar()
		{
			...
			var result = testController.LogOn("karine.goncalves", "123456", null, null, null, url) as RedirectResult;
		...
		{
			this.assertLoginSession("karine.goncalves");
			this.assertLoginSession("mario.lima");
		}
		...
		public void DeveLancarErroNoCatcher()
		{
			...
			var result = buggyController.LogOn("karine.goncalves", "123456", null, null, null, null) as ViewResult;
