...
using ex = System.CodeDom.Compiler.Executor;
...
namespace Tecnomapas.EtramiteX.Credenciado.Model.ModuloPessoa.Business
{
    public class PessoaBus
    {
        ...
        IPessoaInternoValidar _validar = null;

        PessoaInternoDa _da = new PessoaInternoDa();
        ...
        public PessoaBus(IPessoaInternoValidar pessoaValidar, string Esquema = null)
        {
