	...
	<script type="text/javascript">
		$(function () {
			Dominialidade.load($('#central'), {
				urls: {
					salvar: '<%= Url.Action("Editar", "Dominialidade") %>',
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">	
	<div id="central">
		...
		<div class="block box">
			...
			<span class="cancelarCaixa"><span class="btnModalOu">ou</span> <a class="linkCancelar" href="<%= Url.Action("", "Caracterizacao", new { id = Model.Caracterizacao.EmpreendimentoId, projetoDigitalId=Model.ProjetoDigitalId}) %>">Cancelar</a></span>
		</div>
	</div>
</asp:Content>