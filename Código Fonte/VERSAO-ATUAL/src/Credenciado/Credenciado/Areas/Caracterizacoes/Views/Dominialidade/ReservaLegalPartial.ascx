        ...
        <div class="divCamposSituacaoRegistrada <%=(Model.ReservaLegal.SituacaoId == (int)eReservaLegalSituacao.Registrada) ? "" : "hide" %>">
            ...
            <div class="block">
                ...
                <div class="coluna21 append2">
                    <label for="ReservaLegal_NumeroTermo">Nº de Matrícula 
                        ...
                        <span class="cedente <%=Model.ReservaLegal.CompensacaoTipo == eCompensacaoTipo.Cedente? "":"hide" %>">do Receptor</span> *
            ...
            <div class="block  receptora <%=Model.ReservaLegal.CompensacaoTipo == eCompensacaoTipo.Receptora && Model.ReservaLegal.CedentePossuiEmpreendimento == 0 ? "": "hide" %>">
                <div class="coluna18 append2">
                    ...
                    <%= Html.TextBox("ARLCedida", Model.ReservaLegal.ARLCedida > 0? Model.ReservaLegal.ARLCedida.ToString() : "", ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "maskDecimalPonto text txtARLCedida" }))%>
                </div>
            ...
            <div class="block">
                ...
                <div class="coluna18 cedente append2 <%=Model.ReservaLegal.CompensacaoTipo == eCompensacaoTipo.Cedente? "": "hide" %>">
                    ...
                    <%= Html.TextBox("ARLRecebida", Model.ReservaLegal.ARLRecebida > 0? Model.ReservaLegal.ARLRecebida.ToString() : "", ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "maskDecimalPonto text txtARLRecebida" }))%>
                </div>
        ...
        <fieldset class="block boxBranca divCompensacao 
            ...
            <div class="block">
                <div class="coluna60">
                    ...
                    <%= Html.DropDownList("MatriculaIdentificacao", Model.MatriculaCompensacao, ViewModelHelper.SetaDisabled(Model.MatriculaCompensacao.Count <= 2 || Model.IsVisualizar, new { @class = "text ddlMatriculasCompensacao"}))%>
                </div>
