					...
					<tbody>
						...
						<tr>
							...
							<td width="25%">
								...
								<% if (!Model.IsVisualizar && Model.CaracterizacoesAssociadas.Any(x => x.Tipo == eCaracterizacao.BarragemDispensaLicenca)) { %><%} %>
					...
					<tbody>
						...
						<tr>
							...
							<td width="13%">
								...
								<% if (!temModeloCarac && !item.PodeCopiar) { %><input title="Cadastrar" class="icone criarNovo btnAdicionar" type="button" /><% } %>
							</td>
						</tr>
						<% } %>
					</tbody>
