...
<fieldset class="block boxBranca">
	...
	<legend class="titFiltros">Responsável técnico pela elaboração da Declaração de Dispensa de Licenciamento Ambiental de Barragem</legend>
		...
		<div class="block">
			...
			<div class="coluna30">
				...
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[0].nome, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text txtRTElaboracaoDeclaracaoNome", maxlength = "80" })) %>
			</div>
			<div class="coluna30">
				<label for="RTProfissao">Profissão *</label>
				<%= Html.DropDownList("RT", Model.profissoesLst[0], ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text ddlRTElaboracaoDeclaracaoProfissao" }))%>
			</div>
			<div class="coluna30">
				<label for="RTCREA">Registro CREA/ES *</label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[0].registroCREA, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text txtRTElaboracaoDeclaracaoCREA", maxlength = "14" })) %>
			</div>
		</div>
		<div class="block">
			<div class="coluna30">
				<label for="RTNum">Número da ART de elaboração da Declaração de Dispensa de Licenciamento Ambiental de Barragem *</label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[0].numeroART, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text txtRTElaboracaoDeclaracaoNumero", maxlength = "14" })) %>
			</div>
		</div>
	</fieldset>
	...
	<legend class="titFiltros">Responsável técnico pela elaboração do projeto técnico ou do laudo de barragem construída</legend>
		...
		<div class="block">
			...
			<div class="coluna30">
				...
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[1].nome, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text txtRTElaboracaoProjetoNome", maxlength = "80" })) %>
			</div>
			<div class="coluna30">
				<label for="RTProfissao">Profissão *</label>
				<%= Html.DropDownList("RT", Model.profissoesLst[1], ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text ddlRTElaboracaoProjetoProfissao" }))%>
			</div>
			<div class="coluna30">
				<label for="RTCREA">Registro CREA/ES *</label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[1].registroCREA, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text txtRTElaboracaoProjetoCREA", maxlength = "14" })) %>
			</div>
		</div>
		<div class="block">
			<div class="block">
	...
	<legend class="titFiltros">Responsável técnico pela execução da barragem ou das adequações</legend>
		...
		<div class="block">
			<label class ="coluna25">
				<%= Html.CheckBox("CopiaDeclarante", false, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "checkbox cbCopiaDeclarante" }))%>
				Próprio Declarante
			</label> <br />
		</div>
		<div class="block">
			<div class="coluna30">
				<label for="DiametroTubulacaoVazaoMin">Nome </label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[2].nome, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtNome txtRTExecucaoBarragemNome", maxlength = "80" })) %>
			</div>
			<div class="coluna30">
				<label for="RTProfissao">Profissão </label>
				<%= Html.DropDownList("RT", Model.profissoesLst[2], ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtProfissao ddlRTExecucaoBarragemProfissao" }))%>
			</div>
			<div class="coluna30">
				<label for="RTCREA">Registro CREA/ES </label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[2].registroCREA, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtCREA txtRTExecucaoBarragemCREA", maxlength = "14" })) %>
			</div>
		</div>
		<div class="block">
			<div class="coluna30">
	...
	<legend class="titFiltros">Responsável técnico pela elaboração do Plano de Recuperação de Área Degradada referente a APP no entorno do reservatório</legend>
		...
		<div class="block">
			<div class="coluna30">
				<label for="DiametroTubulacaoVazaoMin">Nome</label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[4].nome, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtNome txtRTElaboracaoPlanoRecuperacaoNome", maxlength = "80" })) %>
			</div>
			<div class="coluna30">
				<label for="RTProfissao">Profissão</label>
				<%= Html.DropDownList("RT", Model.profissoesLst[4], ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtProfissao ddlRTElaboracaoPlanoRecuperacaoProfissao" }))%>
			</div>
			<div class="coluna30">
				<label for="RTCREA">Registro CREA/ES</label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[4].registroCREA, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtCREA txtRTElaboracaoPlanoRecuperacaoCREA", maxlength = "14" })) %>
			</div>
		</div>
		<div class="block">
			<div class="coluna30">
	...
	<legend class="titFiltros">Responsável técnico pela execução do Plano de Recuperação de Área Degradada referente à APP do entorno do reservatório</legend>
		...
		<div class="block">
			<div class="coluna30">
				<label for="DiametroTubulacaoVazaoMin">Nome</label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[5].nome, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtNome txtRTExecucaoPlanoRecuperacaoNome", maxlength = "80" })) %>
			</div>
			<div class="coluna30">
				<label for="RTProfissao">Profissão</label>
				<%= Html.DropDownList("RT", Model.profissoesLst[5], ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtProfissao ddlRTExecucaoPlanoRecuperacaoProfissao" }))%>
			</div>
			<div class="coluna30">
				<label for="RTCREA">Registro CREA/ES</label>
				<%= Html.TextBox("RT", Model.Caracterizacao.responsaveisTecnicos[5].registroCREA, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text rtCREA txtRTExecucaoPlanoRecuperacaoCREA", maxlength = "14" })) %>
			</div>
		</div>
		<div class="block">
			<div class="coluna30">
