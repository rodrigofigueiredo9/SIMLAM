...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		...
		<div class="block box">
			...
			<span class="cancelarCaixa"><span class="btnModalOu">ou</span> <a class="linkCancelar" href="<%= Url.Action("", "Caracterizacao", new { id = Model.UnidadeProducao.Empreendimento.Id, projetoDigitalId = Request.Params["projetoDigitalId"]}) %>">Cancelar</a></span>
		</div>
	</div>
</asp:Content>