		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<input title="Visualizar" class="icone visualizar btnDominioVisualizar" type="button"/>
					<% if(!Model.IsVisualizar) { %><input title="Editar" class="icone editar btnDominioEditar" type="button"/><% } %>
				</td>
			</tr>
			<% }%>
		</tbody>
