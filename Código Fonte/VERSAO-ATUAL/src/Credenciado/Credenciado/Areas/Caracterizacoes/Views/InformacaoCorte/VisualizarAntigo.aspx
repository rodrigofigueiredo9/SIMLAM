...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Credenciado.Master" Inherits="System.Web.Mvc.ViewPage<InformacaoCorteAntigoVM>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		...
		<div class="block box divLinkVoltar">
			<span><a class="linkCancelar" href="<%= Url.Action("Listar", "InformacaoCorte", new { id = Model.Caracterizacao.EmpreendimentoId , Model.ProjetoDigitalId}) %>">Voltar</a></span>
		</div>
	</div>
</asp:Content>