...
Dominialidade = {
	...
	abrirModalMerge: function (textoModal) {
		Modal.confirma({
			...
			btnOkCallback: function (conteudoModal) {
				MasterPage.carregando(true);
				$.ajax({
					url: Dominialidade.settings.urls.mergiar,
					data: JSON.stringify(Dominialidade.obter()),
					cache: false,
					async: false,
					type: 'POST',
	...
	obter: function () {
		var objeto = {
			...
			ProjetoDigitalId: $('.hdnProjetoDigitalId', Dominialidade.container).val(),
			...
			InternoId: $('.hdnInternoId', Dominialidade.container).val(),
	...
	salvar: function () {
		MasterPage.carregando(true);
		$.ajax({
			url: Dominialidade.settings.urls.salvar,
			data: JSON.stringify(Dominialidade.obter()),
			cache: false,
			async: false,
			type: 'POST',
