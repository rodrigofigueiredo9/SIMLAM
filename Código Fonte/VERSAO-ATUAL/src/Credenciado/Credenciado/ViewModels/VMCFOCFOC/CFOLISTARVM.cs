...
namespace Tecnomapas.EtramiteX.Credenciado.ViewModels.VMCFOCFOC
{
	public class CFOListarVM
	{
		...
		public CFOListarVM() : this(new List<QuantPaginacao>(), new List<Lista>()) { }

		public CFOListarVM(List<QuantPaginacao> quantPaginacao, List<Lista> situacoes)
		{
