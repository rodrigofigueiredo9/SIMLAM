<%@ Import Namespace="Tecnomapas.EtramiteX.Credenciado.ViewModels.VMAgrotoxicos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsHeadContent" runat="server">
	<script type="text/javascript" src="<%= Url.Content("~/Scripts/Agrotoxicos/listar.js") %>" ></script>
	<script type="text/javascript">
		$(function () {
			AgrotoxicoListar.load($('#central'));
			AgrotoxicoListar.urlPDF = '<%= Url.Action("BaixarPdfAgrotoxico", "Agrotoxicos") %>';
		});
	</script>
</asp:Content>
