...
<script type="text/javascript">
	if (typeof PessoaAssociar != 'undefined') {
		...
		PessoaAssociar.settings = {
			...
			visualizando: <%= (Model.Pessoa.Id > 0 || Model.Pessoa.InternoId > 0).ToString().ToLower() %>,
...
<% if (Model.Pessoa.Id <= 0 && !Model.IsVisualizar) { %>
...
<div class="block box divPessoaContainer hide">
	...
	<span class="btnModalCancelar cancelarCaixa"><span class="btnModalOu">ou
	</span><a class="linkCancelar" title="Cancelar">Cancelar</a></span>
</div>