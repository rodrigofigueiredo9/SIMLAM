...
<div class="block box">
	...
	<span class="floatRight spnCancelarCadastro"><a class="linkCancelar" href="<%= Url.Action("Operar", "ProjetoDigital", (Model.ProjetoDigitalId > 0) ? new { id = Model.ProjetoDigitalId } : null) %>">Cancelar</a></span>
</div>
<%}%>
