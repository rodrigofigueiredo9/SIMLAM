	...
	public class BarragemDispensaLicencaDa
	{
		...
		public List<BarragemDispensaLicenca> ObterLista(int empreendimentoId, bool simplificado = false, BancoDeDados banco = null)
		{
			...
			using (BancoDeDados bancoDeDados = BancoDeDados.ObterInstancia(banco, EsquemaCredenciadoBanco))
			{
                ...
                from crt_barragem_dispensa_lic c, lov_crt_bdla_barragem_tipo lt where lt.id = c.tipo_barragem and c.EMPREENDIMENTO = :empreendimentoId", EsquemaCredenciadoBanco);
