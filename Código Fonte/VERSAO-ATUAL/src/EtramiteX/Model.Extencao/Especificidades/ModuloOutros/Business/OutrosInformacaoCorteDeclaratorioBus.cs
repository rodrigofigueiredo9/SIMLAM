...
{
	public class OutrosInformacaoCorteDeclaratorioBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		OutrosInformacaoCorteDeclaratorioDa _da = new OutrosInformacaoCorteDeclaratorioDa();
