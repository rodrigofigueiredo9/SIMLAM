...
{
	public class LaudoVistoriaFomentoFlorestalBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		#region Propriedades
		...
		{
			get { return new LaudoVistoriaFomentoFlorestalValidar(); }
		}
		...
		{
			return Deserialize(input, typeof(LaudoVistoriaFomentoFlorestal));
		}
