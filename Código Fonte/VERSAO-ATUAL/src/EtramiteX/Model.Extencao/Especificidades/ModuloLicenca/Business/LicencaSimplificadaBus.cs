...
{
	public class LicencaSimplificadaBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		LicencaSimplificadaDa _da = new LicencaSimplificadaDa();
		...
		{
			get { return new LicencaSimplificadaValidar(); }
		}
		...
		{
			LicencaSimplificada Licenca = especificidade as LicencaSimplificada;
		...
		{
			return Deserialize(input, typeof(LicencaSimplificada));
		}
