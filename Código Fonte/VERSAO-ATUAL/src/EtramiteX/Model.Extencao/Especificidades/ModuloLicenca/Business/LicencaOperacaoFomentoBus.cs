...
{
	public class LicencaOperacaoFomentoBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		LicencaOperacaoFomentoDa _da = new LicencaOperacaoFomentoDa();
		...
		public override List<DependenciaLst> ObterDependencias(IEspecificidade especificidade)
		{
			...
			retorno.Add(new DependenciaLst() { TipoId = (int)eTituloDependenciaTipo.Caracterizacao, DependenciaTipo = (int)eCaracterizacao.SilviculturaPPFF });
			return retorno;
		}

		public IEspecificiadeValidar Validar
		{
			get { return new LicencaOperacaoFomentoValidar(); }
		}
		...
		{
			return Deserialize(input, typeof(LicencaOperacaoFomento));
		}
