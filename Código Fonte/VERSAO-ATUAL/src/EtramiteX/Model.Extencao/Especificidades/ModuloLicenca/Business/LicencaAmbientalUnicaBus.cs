...
{
	public class LicencaAmbientalUnicaBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		LicencaAmbientalUnicaDa _da = new LicencaAmbientalUnicaDa();
		...
		{
			get { return new LicencaAmbientalUnicaValidar(); }
		}
		...
		{
			LicencaAmbientalUnica Licenca = especificidade as LicencaAmbientalUnica;
		...
		{
			return Deserialize(input, typeof(LicencaAmbientalUnica));
		}
		...
		public object ObterDadosPdf(IEspecificidade especificidade, BancoDeDados banco)
		{
			try
			{
				...
				EspecificidadeBusBase.DataEmissaoPorExtenso(licenca.Titulo);
