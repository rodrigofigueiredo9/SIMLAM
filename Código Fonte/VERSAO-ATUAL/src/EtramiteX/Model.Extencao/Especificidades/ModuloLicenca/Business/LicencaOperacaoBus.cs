...
{
	public class LicencaOperacaoBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		LicencaOperacaoDa _da = new LicencaOperacaoDa();
		...
		{
			get { return new LicencaOperacaoValidar(); }
		}
		...
		{
			LicencaOperacao Licenca = especificidade as LicencaOperacao;
		...
		{
			return Deserialize(input, typeof(LicencaOperacao));
		}
