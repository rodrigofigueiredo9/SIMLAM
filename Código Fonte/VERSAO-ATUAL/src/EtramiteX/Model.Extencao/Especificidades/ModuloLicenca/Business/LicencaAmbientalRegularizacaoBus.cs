...
{
	public class LicencaAmbientalRegularizacaoBus : EspecificidadeBusBase, IEspecificidadeBus
	{
		LicencaAmbientalRegularizacaoDa _da = new LicencaAmbientalRegularizacaoDa();
		...
		{
			get { return new LicencaAmbientalRegularizacaoValidar(); }
		}
		...
		{
			LicencaAmbientalRegularizacao Licenca = especificidade as LicencaAmbientalRegularizacao;
		...
		{
			return Deserialize(input, typeof(LicencaAmbientalRegularizacao));
		}
