	...
	public class ProtocoloDa
	{
		...
		public Resultados<Protocolo> Filtrar(Filtro<ListarProtocoloFiltro> filtros, BancoDeDados banco = null)
		{
			...
			using (BancoDeDados bancoDeDados = BancoDeDados.ObterInstancia(banco))
			{
				...
				comandtxt += comando.FiltroIn("l.protocolo_id", "select t.protocolo from tab_tramitacao t where t.numero_autuacao = :numero_autuacao", "numero_autuacao", filtros.Dados.NumeroAutuacaoDoc);
