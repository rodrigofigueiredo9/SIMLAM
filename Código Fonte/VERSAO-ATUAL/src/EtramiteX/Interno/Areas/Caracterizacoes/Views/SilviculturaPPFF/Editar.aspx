...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Editar silvicultura – programa produtor florestal (fomento)</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="JsHeadContent" runat="server">
	<script type="text/javascript" src="<%= Url.Content("~/Scripts/Areas/Caracterizacoes/silviculturaPPFF.js") %>"></script>
	
	<script type="text/javascript">
		$(function () {
			SilviculturaPPFF.load($('#central'), {
				urls: {
					salvar: '<%= Url.Action("Editar", "SilviculturaPPFF") %>'
				},
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		<h1 class="titTela">Editar silvicultura – programa produtor florestal (fomento)</h1>
		<br />
