...
<script>
	...
	UnidadeProducaoItem.settings.responsaveisTecnicos = <%=ViewModelHelper.Json(Model.UnidadeProducaoItem.ResponsaveisTecnicos)%>;
</script>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" value="<%=item.Id %>" class="hdnItemResponsavelId" />
						<input type="hidden" value="<%=item.IdRelacionamento %>" class="hdnItemResponsavelRelacionamentoId" />
					</td>
					<%} %>
				</tr>
				<% } %>
				<tr class="trTemplate hide">
					...
					<td>
						<a class="icone excluir btnExcluirResponsavelTecnico"></a>
						<input type="hidden" value="0" class="hdnItemResponsavelId" />
						<input type="hidden" value="0" class="hdnItemResponsavelRelacionamentoId" />
					</td>
				</tr>
			</tbody>
		</table>
