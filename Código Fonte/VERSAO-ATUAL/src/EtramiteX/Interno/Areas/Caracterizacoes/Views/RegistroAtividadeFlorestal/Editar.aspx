...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Editar Registro de Atividade Florestal</asp:Content>
	...
	<script>
		$(function () {
			RegistroAtividadeFlorestal.load($('#central'), {
				urls: { salvar: '<%= Url.Action("Editar", "RegistroAtividadeFlorestal") %>' }
			});
		});
	</script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="central">
		<h1 class="titTela">Editar Registro de Atividade Florestal</h1>
		<br />
