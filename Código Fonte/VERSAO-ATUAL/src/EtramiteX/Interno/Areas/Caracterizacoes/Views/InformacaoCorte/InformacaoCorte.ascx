...
<script>
		...
		InformacaoCorte.settings.textoMerge = '<%= Model.TextoMerge %>';
		InformacaoCorte.settings.atualizarDependenciasModalTitulo = '<%= Model.AtualizarDependenciasModalTitulo %>';
    
    <%if(!Model.IsVisualizar) {%>
		InformacoesCortesInformacoes.settings.urls.salvar = '<%= Url.Action("InformacaoCorteInformacaoCriar", "InformacaoCorte") %>';
		InformacoesCortesInformacoes.settings.urls.editar = '<%= Url.Action("InformacaoCorteInformacaoEditar", "InformacaoCorte") %>';
		InformacoesCortesInformacoes.settings.urls.Excluir = '<%= Url.Action("InformacaoCorteInformacaoExcluir", "InformacaoCorte") %>',
		InformacoesCortesInformacoes.settings.urls.ExcluirConfirm = '<%= Url.Action("InformacaoCorteInformacaoExcluirConfirm", "InformacaoCorte") %>',
	<%} %>
