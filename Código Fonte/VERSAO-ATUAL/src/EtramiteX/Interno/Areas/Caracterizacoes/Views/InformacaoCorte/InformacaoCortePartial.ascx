    ...
    <fieldset class="block box">
        ...
        <div class="block">
            ...
            <div class="coluna20">
				...
				<%} else  {%>
					<%= Html.TextBox("AreaImovel", Model.AreaImovel.ToStringTrunc(), ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @maxlength = "100", @class = "text maskDecimalPonto areaImovelInf" }))%>
				<%} %>
            </div>
        </div>
