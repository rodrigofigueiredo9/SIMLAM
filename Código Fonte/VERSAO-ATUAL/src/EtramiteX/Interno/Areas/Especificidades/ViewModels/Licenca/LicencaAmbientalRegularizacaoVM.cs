...
{
	public class LicencaAmbientalRegularizacaoVM
	{
		...
		private LicencaAmbientalRegularizacao _licenca = new LicencaAmbientalRegularizacao();
		public LicencaAmbientalRegularizacao Licenca
		{
			get { return _licenca; }
			set { _licenca = value; }
		}
		...
		public LicencaAmbientalRegularizacaoVM(List<Protocolos> processosDocumentos, List<AtividadeSolicitada> atividades, List<PessoaLst> destinatarios, LicencaAmbientalRegularizacao licenca, List<TituloCondicionante> condicionantes, string processoDocumentoSelecionado, bool isVisualizar, int atividadeSelecionada)
		{
		...
		public LicencaAmbientalRegularizacaoVM() { }
	}
}