...
{
	public class LicencaSimplificadaVM
	{
		...
		private LicencaSimplificada _licenca = new LicencaSimplificada();
		public LicencaSimplificada Licenca
		{
			get { return _licenca; }
			set { _licenca = value; }
		}
		...
		public LicencaSimplificadaVM(List<Protocolos> processosDocumentos, List<AtividadeSolicitada> atividades, List<PessoaLst> destinatarios, LicencaSimplificada licenca, List<TituloCondicionante> condicionantes, string processoDocumentoSelecionado, bool isVisualizar, int atividadeSelecionada)
		{
