...
{
	public class EscrituraPublicaDoacaoVM
	{
		public bool IsVisualizar { get; set; }

		private EscrituraPublicaDoacao _escritura = new EscrituraPublicaDoacao();
		public EscrituraPublicaDoacao Escritura
		{
		...
		public EscrituraPublicaDoacaoVM(EscrituraPublicaDoacao escritura, List<Protocolos> processosDocumentos, List<AtividadeSolicitada> atividades, List<PessoaLst> destinatarios, 
