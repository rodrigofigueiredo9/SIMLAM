...
<script src="<%= Url.Content("~/Scripts/Areas/Especificidades/Laudo/laudoVistoriaQueimaControlada.js") %>"></script>

<script>
	LaudoVistoriaFlorestal.urlEspecificidade = '<%= Url.Action("LaudoVistoriaQueimaControlada", "Laudo", new {area="Especificidades"}) %>';
	LaudoVistoriaFlorestal.urlObterDadosLaudoVistoriaFlorestal = '<%= Url.Action("ObterDadosLaudoVistoriaQueimaControlada", "Laudo", new {area="Especificidades"}) %>';
