...
<fieldset class="block box divEspecificidade">
	...
	<div class="block hide divRestricao">
		<div class="ultima">
			...
			<%= Html.TextArea("Laudo.Restricao", Model.Laudo.Restricao, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "textarea media text txtRestricao", @maxlength = "1000" }))%>
		</div>
	</div>
</fieldset>
