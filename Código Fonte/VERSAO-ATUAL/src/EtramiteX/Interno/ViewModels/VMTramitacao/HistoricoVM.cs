...
namespace Tecnomapas.EtramiteX.Interno.ViewModels.VMTramitacao
{
	public class HistoricoVM
	{
		...
		public void CarregarHistorico(List<Tramitacao> hstTramitacao, Resultados<HistoricoProtocolo> ApensadoJuntado, string numero, string tipoTexto, int protocolo)
		{
			Numero = numero;
