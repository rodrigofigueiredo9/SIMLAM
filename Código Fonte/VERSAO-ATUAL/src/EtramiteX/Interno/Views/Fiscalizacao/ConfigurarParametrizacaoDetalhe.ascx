...
<div class="block dataGrid"> 
  <div class="coluna25"> 
    <table class="dataGridTable tabDetalhe" width="100%" border="0" cellspacing="0" cellpadding="0" rules="all"> 
      ...
      <tbody>
          <% foreach (var detalhe in Model.ParametrizacaoDetalhes){ %>
            <tr> 
              <td> 
			  ...
			  <td> 
                <span class="maximoParcelas" title="<%:detalhe.MaximoParcelas%>"><%:String.Format("{0:N2}", detalhe.MaximoParcelas)%></span> 
              </td> 
              <td class="tdAcoes"> 
