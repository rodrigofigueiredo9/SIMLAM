    ...
    <fieldset class="box fsInfracao fsDadosInfracao">
        <div class="block divDescricaoInfracao">
		    <div class="coluna76">
			    ...
			    <%= Html.TextArea("Infracao.DescricaoInfracao", Model.Infracao.DescricaoInfracao, ViewModelHelper.SetaDisabledReadOnly(Model.IsVisualizar, new { @class = "text media txtDescricaoInfracao", @maxlength = "1500" }))%>
		    </div>
	    </div>
