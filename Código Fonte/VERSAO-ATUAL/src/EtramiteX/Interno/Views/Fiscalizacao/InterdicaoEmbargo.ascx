    ...
    <fieldset class="block box fsCamposInterdicaoEmbargo">
        <div class="block">
            <div class="coluna20">
		        ...
		        <%= Html.TextBox("ObjetoInfracao.NumeroIUF", ((Model.Entidade.IsDigital == true && Model.Entidade.NumeroIUF == null) ? "Gerado automaticamente" : Model.Entidade.NumeroIUF), ViewModelHelper.SetaDisabled((Model.IsVisualizar || Model.Entidade.IsDigital == true), new { @class = "text maskNumInt txtNumeroIUF", @maxlength = "6" }))%>
	        </div>
    ...
    <fieldset class="block box fsCamposInterdicaoEmbargo">
        ...
        <div class="block">
			<div style="margin-top:7px" class="coluna75">
				...
				<%= Html.TextBox("ObjetoInfracao.DescricaoTermoEmbargo", Model.Entidade.DescricaoTermoEmbargo, ViewModelHelper.SetaDisabled(Model.IsVisualizar, new { @class = "text txtDescricaoTermoEmbargo", @maxlength = "600" }))%>
			</div>
		</div>
