...
<fieldset class="block box">
	<div class="block">
		...
		<div class="ultima prepend2 divBotoesProtocolo">
			...
			<span class="spnVisualizarProtocolo <%=(Model.Solicitacao.Protocolo.Id > 0) ? "" : "hide" %>">
				<button type="button" title="Visualizar protocolo" class="icone visualizar inlineBotao btnVisualizarProtocolo"></button>
			</span>
		</div>
	</div>
