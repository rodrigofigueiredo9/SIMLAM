...
<div class="requerimentoPartial">
			...
			<div class="asmItens">
				<% foreach (var atividade in Model.AtividadesSolicitadasVM) { %>
					<div class="asmItemContainer" style="border:0px">
						<% atividade.IsRequerimento = !Model.IsRequerimentoDocumento; %>
	...
	<fieldset class="block box">
		...
		<div class="coluna60">
			...
			<%= Html.TextBox("Documento.Interessado.NomeRazaoSocial", Model.Interessado.NomeRazaoSocial, new { @class = "text disabled txtIntNome", @disabled = "disabled" })%>
		</div>
		<div class="coluna16 prepend2">
			<label>CPF/CNPJ *</label>
			<%= Html.TextBox("Documento.Interessado.CPFCNPJ", Model.Interessado.CPFCNPJ, new { @class = "text disabled txtIntCnpj", @disabled = "disabled" })%>
		</div>
		<div class="prepend2">
	...
	<fieldset class="block box">
		...
		<div class="coluna60">
			...
			<%= Html.TextBox("Documento.Empreendimento.Denominador", Model.Empreendimento.Denominador, new { @class = "text disabled txtEmpDenominador", @disabled = "disabled" })%>
		</div>
		<div class="coluna16 prepend2">
			<label>CNPJ</label>
			<%= Html.TextBox("Documento.Empreendimento.CNPJ", Model.Empreendimento.CNPJ, new { @class = "text disabled tctEmpCnpj", @disabled = "disabled" })%>
		</div>
		<div class="prepend2">
