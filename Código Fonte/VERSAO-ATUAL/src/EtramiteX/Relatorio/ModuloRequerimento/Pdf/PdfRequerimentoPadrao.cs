...
{
	public class PdfRequerimentoPadrao : PdfPadraoRelatorio
	{
		IRelatorioRequerimentoDa _da;

		public PdfRequerimentoPadrao(IRelatorioRequerimentoDa da = null)
		{
			if (da == null)
			{
		...
		public MemoryStream Gerar(int id)
		{
			...
			RequerimentoRelatorio dataSource = new RequerimentoRelatorio();
