...
namespace Tecnomapas.EtramiteX.WindowsService.ProcessOperacoesPublicoGeo.Business.PDF.CabecalhoRodape
{
	public class PdfCabecalhoRodape : PdfPageEventHelper, IPageMirroring
	{
        ...
        private static Stream ImagemOrgao { get { return Assembly.GetExecutingAssembly().GetManifestResourceStream("Tecnomapas.EtramiteX.WindowsService.ProcessOperacoesPublicoGeo.Business.PDF.Imagens.logomarca.png"); } }

		private static Stream ImagemSimlam { get { return Assembly.GetExecutingAssembly().GetManifestResourceStream("Tecnomapas.EtramiteX.WindowsService.ProcessOperacoesPublicoGeo.Business.PDF.Imagens.logomarca_simlam.png"); } }
