...
Documento = {
	...
	configurarAssociarMultiplo: function () {
		...
		$('.divConteudoResponsavelTec', Documento.settings.container).associarMultiplo({
			...
			'associarModalObject': null,//Documento.pessoaModalResp,
			'associarModalLoadFunction': null, //Documento.pessoaModalResp.load,
			...
			'editarModalObject': null, //Documento.pessoaModalResp,
			'editarModalLoadFunction': null, //Documento.pessoaModalResp.load,
		...
		if (!containerLink.hasClass('hide')) {
			$('.conteudoResponsaveis', Documento.settings.container).find('.btnAsmEditar').hide();
		}
	},
