...
namespace Tecnomapas.Blocos.Etx.ModuloValidacao
{
	...
	public class TramitacaoMsg
	{
		...
		public Mensagem NaoExisteNotificacao { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Texto = "Não é possível tramitar o processo/documento, pois não existe notificação para a fiscalização do mesmo." }; } }
	}
}