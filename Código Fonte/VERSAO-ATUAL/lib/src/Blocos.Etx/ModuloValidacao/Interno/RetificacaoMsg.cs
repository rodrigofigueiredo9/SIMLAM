...
namespace Tecnomapas.Blocos.Etx.ModuloValidacao
{
    ...
    public class RetificacaoMsg
    {
        ...
        public Mensagem msgCred4() { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Texto = string.Format("Caso tenha ocorrido alteração de dados do proprietário/empreendimento/dominialidade após o envio da Solicitação de inscrição no CAR ao SICAR é necessário enviar uma nova Solicitação de inscrição no CAR.") }; }
        ...
        public Mensagem msgInst4() { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Texto = string.Format("Caso tenha ocorrido alteração de dados do proprietário/empreendimento/dominialidade após o envio da Solicitação de inscrição no CAR ao SICAR é necessário enviar uma nova Solicitação de inscrição no CAR.") }; }
