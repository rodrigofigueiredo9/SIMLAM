...
namespace Tecnomapas.Blocos.Etx.ModuloValidacao
{
	...
	public class ExploracaoFlorestalMsg
	{
		...
		public Mensagem DestinacaoMateriallObrigatoria { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = "DestinacaoMaterial", Texto = @"Destinação do Material é obrigatória." }; } }
		...
		public Mensagem FinalidadeExploracaoEspecificarObrigatorio(string identificacao)
		{
			return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = String.Format("ExploracaoFlorestal_Exploracoes_FinalidadeExploracao{0}, #exploracao{0}", identificacao), Texto = @"Especificar da finalidade da exploração florestal é obrigatório." };
		}
