...
namespace Tecnomapas.Blocos.Etx.ModuloValidacao
{
	...
	public class OutrosInformacaoCorteMsg
	{
		...
		public Mensagem CaracterizacaoJaAssociadaNaoEmitido { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Texto = "A caracterização de informação de corte selecionada já se encontra associada a outro título." }; } }
