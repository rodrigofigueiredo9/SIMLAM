namespace Tecnomapas.Blocos.Etx.ModuloValidacao
{
	...
	{
		private static SimuladorGeoMsg _simulador = new SimuladorGeoMsg();
		public static SimuladorGeoMsg SimuladorGeo
		{
			get { return _simulador; }
			set { _simulador = value; }
		}
	}

	public class SimuladorGeoMsg
	{
		//#region Mensagem
		...
		public Mensagem CpfInvalido { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = "txtCpf", Texto = "O CPF informado é inválido, informe um número válido para fazer a verificação." }; } }
		public Mensagem CpfObrigatorio { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = "txtCpf", Texto = "CPF é obrigatório." }; } }

		public Mensagem EastingObrigatorio { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = "txtEasting", Texto = "Easting é obrigatório." }; } }
		public Mensagem NorthingObrigatorio { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = "txtNorthing", Texto = "Northing é obrigatório." }; } }

		public Mensagem EastingInvalido { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = "txtEasting", Texto = "Easting informado é inválido." }; } }
		public Mensagem NorthingInvalido { get { return new Mensagem() { Tipo = eTipoMensagem.Advertencia, Campo = "txtNorthing", Texto = "Northing informado é inválido." }; } }
