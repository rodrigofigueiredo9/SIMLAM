...
{
	public class FiscalizacaoRelatorio : IAssinanteDataSource
	{
		...
		private LocalInfracaoRelatorio _localInfracao = new LocalInfracaoRelatorio();
		public LocalInfracaoRelatorio LocalInfracao
		{
		...
		private ObjetoInfracaoRelatorio _objetoInfracao = new ObjetoInfracaoRelatorio();
		public ObjetoInfracaoRelatorio ObjetoInfracao
		{
