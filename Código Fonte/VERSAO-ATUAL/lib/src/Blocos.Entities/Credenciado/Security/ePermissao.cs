namespace Tecnomapas.Blocos.Entities.Credenciado.Security
{
	public enum ePermissao
	{
		...
		EmpreendimentoCriarSemCoordenada,
		...
		ProjetoDigitalCriar,
		ProjetoDigitalEditar,
		ProjetoDigitalVisualizar,
		ProjetoDigitalExcluir,
		...
		ConsultarHabilitacaoPraga,

		ConsultarAgrotoxicos,
