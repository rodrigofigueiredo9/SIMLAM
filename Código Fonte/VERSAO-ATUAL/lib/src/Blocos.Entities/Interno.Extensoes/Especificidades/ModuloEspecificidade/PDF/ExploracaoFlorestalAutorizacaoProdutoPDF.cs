...
{
	public class ExploracaoFlorestalAutorizacaoProdutoPDF
	{
		...
		public ExploracaoFlorestalAutorizacaoProdutoPDF() { }

		public ExploracaoFlorestalAutorizacaoProdutoPDF(ExploracaoFlorestalProduto produto)
		{
