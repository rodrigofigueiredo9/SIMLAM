...
DROP INDEX IDAFGEO.UK_FILA_PRO_TIP_MEC;
ALTER TABLE IDAFGEO.TAB_FILA ADD CONSTRAINT UK_TAB_FILA UNIQUE (PROJETO,TIPO,MECANISMO_ELABORACAO,TITULO) ENABLE;

ALTER TABLE IDAF.ESP_AUTO_EXPLORACAO_FLORESTAL MODIFY OBSERVACAO VARCHAR2(500) NULL;