create or replace PACKAGE BODY "HISTORICO" is
	...
	begin
		...
		---------------------------------------------------------
		-- Fiscalização - Complement. dados do autuado
		--------------------------------------------------------- 
		for i in (select f.id,
						 f.fiscalizacao,
						 f.responsavel,
						 f.reside_propriedade,
						 f.renda_mensal_familiar,
						 f.nivel_escolaridade,
						 f.vinc_prop,
						 f.vinc_prop_especif_text,
						 f.conhec_legisl,
						 f.conhec_legisl_justif_text,
						 f.prop_area_total,
						 f.prop_area_cobert_flores_nativ,
						 f.prop_area_reserv_legal,
						 f.tid
					from tab_fisc_compl_dados_aut f
				   where f.fiscalizacao = p_id) loop
		
			insert into hst_fisc_compl_dados_aut
				(id,
				 tid,
				 fiscalizacao_id_hst,
				 complementacao_id,
				 ...
				 nivel_escolaridade,
				 vinc_prop,
				 vinc_prop_especif_text,
				 conhec_legisl,
				 conhec_legisl_justif_text,
				 prop_area_total,
				 prop_area_cobert_flores_nativ,
				 prop_area_reserv_legal)
			values
				(seq_hst_fisc_compl_dados_a.nextval,
				 v_tid,
				 seq_hst_fiscalizacao.currval,
				 i.id,
				 i.fiscalizacao,
				 i.responsavel,
				 i.reside_propriedade,
				 i.renda_mensal_familiar,
				 i.nivel_escolaridade,
				 i.vinc_prop,
				 i.vinc_prop_especif_text,
				 i.conhec_legisl,
				 i.conhec_legisl_justif_text,
				 i.prop_area_total,
				 i.prop_area_cobert_flores_nativ,
				 i.prop_area_reserv_legal);
		end loop;
		------------------------------------------------------------
  ...
  ---------------------------------------------------------
	-- Configuracao Fiscalizacao - Penalidade Infracao
	---------------------------------------------------------
